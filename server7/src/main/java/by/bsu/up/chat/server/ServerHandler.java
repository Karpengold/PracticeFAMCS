...
public class ServerHandler implements HttpHandler {
    ...
    private Response doPut(HttpExchange httpExchange) {
        ...
        try {
            Message message = MessageHelper.getClientUpdateMessage(httpExchange.getRequestBody());
            if(messageStorage.updateMessage(message)){
                ...
                return new Response(Constants.RESPONSE_CODE_BAD_REQUEST, "Message does not found");
            }
